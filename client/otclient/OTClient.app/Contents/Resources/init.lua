...
-- updater
Services = {
    status = "http://209.126.81.68:8080/api/v1/login",
    websites = "http://209.126.81.68:8080/account/manage",
    createAccount = "http://209.126.81.68:8080/account/createaccount",
    getCoinsUrl = "http://209.126.81.68:8080/shop",
    clientAssets = {
        enabled = true,
